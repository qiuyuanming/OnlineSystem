    ...
    <body>
            ...
            <div class="am-container header">
                ...
                <ul class="message-r">
                    ...
                    <div class="topMessage my-shangcheng">
                        <div class="menu-hd MyShangcheng"><a href="viewUser?userId=${user.userId}" target="_top"><i class="am-icon-user am-icon-fw"></i>个人中心</a></div>
                    </div>
                </ul>
            </div>
        ...
        <div class="banner">
            ...
            <div class="am-slider am-slider-default scoll" data-am-flexslider id="demo-slider-0">
                <ul class="am-slides">
                    <li class="banner1"><a href="getProducts?prouctId=${product.productId}"><img src="../images/ad1.jpg" /></a></li>

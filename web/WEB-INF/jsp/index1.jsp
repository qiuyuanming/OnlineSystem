...
<html>
    ...
    <body>
                ...
                <a href="showAllUsers">
                    <dl class="system_log">
                        ...
                        <dd>
                            <img class="coin11" src="../img/coin111.png" /><img class="coin22"
                                                                                src="../img/coin222.png" />
                            <a href="showAllUsers" target="main" class="cks">用户管理</a>
                ...
                <a href="sort.html">
                    <dl class="system_log">
                        ...
                        <dd>
                            <img class="coin11" src="../img/coin111.png" /><img class="coin22"
                                                                                src="../img/coin222.png" />
                            <a href="sort.html" target="main" class="cks">分类管理</a><img class="icon5" src="../img/coin21.png" />
                        </dd>
                    </dl>
                </a>
        ...
        <div id="pageAll" style="margin-left:200px">
            <div class="page">
                <!-- main页面样式 -->
                <div class="indexL">
